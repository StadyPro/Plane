...
<body>
  <form action="index_aircraft_user.php" method="post">
		<input type="submit" name="connect" value="Самолеты">
    </form>
    <form action="index_flights_user.php" method="post">
		<input type="submit" name="connect" value="Рейсы">
    </form>
    <form action="index_passengers_user.php" method="post">
		<input type="submit" name="connect" value="Пассажиры">
    </form>
    <form action="index_tickets_user.php" method="post">
